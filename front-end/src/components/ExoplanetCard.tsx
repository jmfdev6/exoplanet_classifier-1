...
import { Heart, MessageCircle, ExternalLink, Thermometer, Ruler } from 'lucide-react';
...
export function ExoplanetCard({ exoplanet, onLike, onComment, onViewDetails }: ExoplanetCardProps) {
  return (
